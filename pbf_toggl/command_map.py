...
commands = [CommandConfig("add connection", "pbf_toggl.Commands.add_connection.AddConnection", description="Creates a connection for the given token in the Toggl Settings"),
            ...
            CommandConfig("start timer", "pbf_toggl.Commands.start_timer.StartTimer", description="Start the Toggl Timer"),
            CommandConfig("stop timer", "pbf_toggl.Commands.stop_timer.StopTimer", description="Stop the current timer for Toggl")]
